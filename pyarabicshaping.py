...
if __name__ == '__main__':
	...
	s = "سلام بِهداد اسفهبد"
	test = unicode (s, 'utf-8')

	print test[::-1]
	for console in [False, True]:
		for liga in [False, True]:
			print arabic_shape (test, liga = liga, console = console)[::-1]
	for console in [False, True]:
		for liga in [False, True]:
			print arabic_shape (test[::-1], liga = liga, console = console, rtl = False)
